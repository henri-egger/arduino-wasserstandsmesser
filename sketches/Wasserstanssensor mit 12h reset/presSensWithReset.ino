...
int RESET_ITERATIONS_INTERVAL = 6 * 12; // 12 Hours
...
int reset_iterations = 0;

void loop() {
  // Resets the Arduino every 12 hours to prevent crashes
  if (reset_iterations == RESET_ITERATIONS_INTERVAL) {
    resetFunc();
  }
